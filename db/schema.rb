...
ActiveRecord::Schema.define(version: 2020_06_04_132634) do
  ...
  create_table "forums", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.string "title", null: false
  ...
  create_table "users", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci", force: :cascade do |t|
    ...
    t.integer "atack", default: 0, null: false
    t.integer "atack_awake", default: 0, null: false
    t.integer "denfense", default: 0, null: false
    t.integer "gear_score", default: 0, null: false
    t.integer "branch", default: 0, null: false
    t.string "build_url", default: "", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
